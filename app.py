...
[data-testid="stSidebar"] button, [data-testid="stSidebar"] button[kind], [data-testid="stSidebar"] [data-testid*="baseButton"] { background: rgba(255,255,255,0.06) !important; border: 1px solid rgba(255,255,255,0.14) !important; color: #c0c0c0 !important; border-radius: 8px !important; font-size: 14px !important; font-weight: 500 !important; letter-spacing: 0.1px !important; text-align: left !important; padding: 9px 13px !important; margin-bottom: 4px !important; width: 100% !important; box-shadow: none !important; transition: all 0.15s ease !important; height: auto !important; min-height: 38px !important; opacity: 1 !important; display: block !important; visibility: visible !important; }
...
[data-testid="stSidebar"] button:focus, [data-testid="stSidebar"] button:focus-visible, [data-testid="stSidebar"] button:active, [data-testid="stSidebar"] button[data-focused="true"] { background: rgba(255,255,255,0.06) !important; border-color: rgba(255,255,255,0.14) !important; color: #c0c0c0 !important; outline: none !important; box-shadow: none !important; }
