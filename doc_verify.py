...
_DOC_TYPES = [
    ...
    ("Real Estate Certification", ["real estate certification", "real estate cert",
                                   "fha amendatory clause", "amendatory clause",
                                   "buyer seller agent", "buyers sellers agents"]),
    ("Final Selling Disclosure", ["final selling disclosure", "final seller disclosure",
                                  "seller closing disclosure", "seller's closing disclosure",
                                  "sale of current home", "proceeds from sale"]),
...
_PAGE_EXPECTATIONS = {
    ...
    "Real Estate Certification": (1, 3, "1-3 pages typical"),
    "Final Selling Disclosure": (2, 5, "2-5 pages typical"),
